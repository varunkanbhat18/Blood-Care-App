        ...
        registerButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (TextUtils.isEmpty(idNumber)){
                    registerIdNumber.setError("Aadhaar Number is required!");
                    return;
                }
                ...
                if (bloodGroup.equals("Select your blood group")){
                    ...
                    if (isImage1Uploaded == "1") {
                                                    ...
                                                    result.addOnSuccessListener(new OnSuccessListener<Uri>() {
                                                        ...
                                                        public void onSuccess(Uri uri) {
                                                            ...
                                                            userDatabaseRef.updateChildren(newImageMap).addOnCompleteListener(new OnCompleteListener() {
                                                                ...
                                                                public void onComplete(@NonNull Task task) {
                                                                    if (task.isSuccessful()) {
                                                                        Toast.makeText(RecipientRegistrationActivity.this, "Image added successfully", Toast.LENGTH_SHORT).show();
                                                                    } else {
                                                                        Toast.makeText(RecipientRegistrationActivity.this, task.getException().toString(), Toast.LENGTH_SHORT).show();
                                                                    }
                                                                }
                        ...
                        Toast.makeText(getApplicationContext(), "Kindly select image", Toast.LENGTH_SHORT).show();
                    }
                }
            }
        });
